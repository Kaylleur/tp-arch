...
// const NEO4J_URI = 'neo4j+s://7d2c8bed.databases.neo4j.io';
// const NEO4J_USERNAME = 'neo4j';
// const NEO4J_PASSWORD = '7KRX4T7TfGmDtO_ycF408wacKeUb2X7JFvQYaL50rJE';
// const AURA_INSTANCENAME = 'Instance01';

(async() => {
  const neo4j = require('neo4j-driver');

  const uri = 'neo4j+s://7d2c8bed.databases.neo4j.io';
  const user = 'neo4j';
  const password = '7KRX4T7TfGmDtO_ycF408wacKeUb2X7JFvQYaL50rJE';
